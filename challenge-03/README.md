...
*/
pessoa.andar = function(kmCaminhados) {
 pessoa.caminhouQuantosMetros += kmCaminhados;
 pessoa.andando = true;
}
...
*/
pessoa.nomeCompleto(); //'Olá! Meu nome é Lívia Silva Santos!'
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarPeso(); //'Eu peso 80.9 kg.'

/*
Qual a altura da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura(); //'Minha altura é 173m.'
...
pessoa.apresentacao = function () {
  ...
  return "Olá, eu sou " + sexo + " " + nomeCompleto + ", tenho " + pessoa.idade + " " + anos + ", " + pessoa.altura + ", meu peso é " + pessoa.peso + " e, só hoje, eu já caminhei " + pessoa.caminhouQuantosMetros + " " + metros + "!";
}

// Agora, apresente-se ;)
pessoa.apresentacao(); //'Olá, eu sou a Lívia Silva Santos, tenho 38 anos, 173, meu peso é 80.9 e, só hoje, eu já caminhei 10 metros!'```
